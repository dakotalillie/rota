...
function SettingsAddPerson({ engineers, setEngineers }: SettingsAddPersonProps) {
  ...
  function addEngineer() {
    ...
    const newEngineer: Engineer = { id: crypto.randomUUID(), name: trimmedName, email: email.trim(), ...palette }
